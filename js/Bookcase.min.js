    ...
    var c = this,
        ...
        e = {
            1: {
                ...
                height: 110,
                rowH: 136,
                img: ["https://static.anyflip.com/web/bookcase/img/gold-1.png", "https://static.anyflip.com/web/bookcase/img/green-1.png", "https://static.anyflip.com/web/bookcase/img/red-1.png", "https://static.anyflip.com/web/bookcase/img/silver-1.png", "https://static.anyflip.com/web/bookcase/img/yellow-1.png"]
            },
            2: {
                width: 130,
                height: 140,
                rowH: 172,
                img: ["https://static.anyflip.com/web/bookcase/img/gold-2.jpg", "https://static.anyflip.com/web/bookcase/img/green-2.jpg", "https://static.anyflip.com/web/bookcase/img/red-2.jpg", "https://static.anyflip.com/web/bookcase/img/silver-2.jpg", "https://static.anyflip.com/web/bookcase/img/yellow-2.jpg"]
            },
            3: {
                width: 152,
                height: 166,
                rowH: 208,
                img: ["https://static.anyflip.com/web/bookcase/img/gold-3.jpg", "https://static.anyflip.com/web/bookcase/img/green-3.jpg", "https://static.anyflip.com/web/bookcase/img/red-3.jpg", "https://static.anyflip.com/web/bookcase/img/silver-3.jpg", "https://static.anyflip.com/web/bookcase/img/yellow-3.jpg"]
            }
        },
        f = {
            1: ["https://static.anyflip.com/web/bookcase/img/gold-1.png", "https://static.anyflip.com/web/bookcase/img/green-1.png", "https://static.anyflip.com/web/bookcase/img/red-1.png", "https://static.anyflip.com/web/bookcase/img/silver-1.png", "https://static.anyflip.com/web/bookcase/img/yellow-1.png"],
            2: ["https://static.anyflip.com/web/bookcase/img/gold-2.jpg", "https://static.anyflip.com/web/bookcase/img/green-2.jpg", "https://static.anyflip.com/web/bookcase/img/red-2.jpg", "https://static.anyflip.com/web/bookcase/img/silver-2.jpg", "https://static.anyflip.com/web/bookcase/img/yellow-2.jpg"],
            3: ["https://static.anyflip.com/web/bookcase/img/gold-3.jpg", "https://static.anyflip.com/web/bookcase/img/green-3.jpg", "https://static.anyflip.com/web/bookcase/img/red-3.jpg", "https://static.anyflip.com/web/bookcase/img/silver-3.jpg", "https://static.anyflip.com/web/bookcase/img/yellow-3.jpg"],
            4: ["https://static.anyflip.com/web/bookcase/img/gold-4.jpg", "https://static.anyflip.com/web/bookcase/img/green-4.jpg", "https://static.anyflip.com/web/bookcase/img/red-4.jpg", "https://static.anyflip.com/web/bookcase/img/silver-4.jpg", "https://static.anyflip.com/web/bookcase/img/yellow-4.jpg"]
        },
        g = ["https://static.anyflip.com/web/bookcase/img/gold-nav.png", "https://static.anyflip.com/web/bookcase/img/gold-footer.png", "https://static.anyflip.com/web/bookcase/img/green-nav.png", "https://static.anyflip.com/web/bookcase/img/green-footer.png", "https://static.anyflip.com/web/bookcase/img/red-nav.png", "https://static.anyflip.com/web/bookcase/img/red-footer.png", "https://static.anyflip.com/web/bookcase/img/silver-nav.png", "https://static.anyflip.com/web/bookcase/img/silver-footer.png", "https://static.anyflip.com/web/bookcase/img/yellow-nav.png", "https://static.anyflip.com/web/bookcase/img/yellow-footer.png"];
...
function DemoPanel(a, b, c) {
    ...
    var d = $("<iframe class='bomb-box-read af-loading-bg' allowfullscreen frameborder='0'></iframe>"),
        e = d[0],
        f = "object" == typeof c && c.hasOwnProperty("openWindow") ? c.openWindow : 1,
        a = hf_utils.isMobile() ? "" : a + (1 == f ? "&nbsp;&nbsp;<a target='_blank' href='" + b + "'>" + hf_utils.getLangVal("dpTitle") + "</a>" : ""),
        g = hf_utils.isMobile() ? "iframe" : "iframe on-pc",
        h = new LightBox(a, "100%", g),
        i = h.getPanel(),
        j = h.getBox(),
        k = h.getCancelBtn();
    if (d.on("touchmove", function(a) {
            a.preventDefault()
        }), hf_utils.isMobile() && j.append(k), i.addClass("").append(d), h.setStopResize(!0), h.launch(), d.attr("src", b), hf_utils.isMobile()) {
        new ToolTip({
            container: i,
            content: k,
            position: "left",
    ...
    e.onload = e.onreadystatechange = function() {
        this.readyState && "complete" != this.readyState || d.removeClass("af-loading-bg")
    }
}

function BookDetailPanel(a, b, c, d) {
    this.boxWidth = 485, a.css("top", 0);
    var e = new LightBox(hf_utils.getLangVal("bdpTitle"), this.boxWidth),
        f = $("<div class='book-detail-content'></div>").css({
            minHeight: a.outerHeight() + 15
        }),
        g = $("<div class='book-detail-book'></div>").css({
            width: Math.max(a.outerWidth(), 70),
            height: a.outerHeight()
        }),
        h = $("<img class='book-detail-shelf' src='/bookcase/img/shelf.png'>"),
        i = ($("<div class='book-detail-info'></div>"), $("<div class='book-detail-title'>" + hf_utils.encodeHTML(b.title) + "</div>")),
        j = $("<div class='book-detail-page'>" + hf_utils.getLangVal("bdpPage") + ": " + b.pages + "</div>"),
        k = $("<div class='book-detail-desc' title='" + hf_utils.br2nl(hf_utils.encodeHTML(b.description)) + "'>" + hf_utils.encodeHTML(b.description) + "</div>"),
        l = $("<div class='button button-blue button-rounded button-block button-large'>" + hf_utils.getLangVal("bdpView") + "</div>"),
        m = $("<p class='book-detail-time'>" + hf_utils.getLangVal("bdpNewTime") + " " + hf_utils.parseDate(b.newTime).toDateString() + "</p>");
    a.css({
        left: -2
    }), hf_utils.isLteIE8() ? (a.on("click", function() {
        e.cancel(), new DemoPanel(b.title, c, d)
    }), l.on("click", function() {
        e.cancel(), new DemoPanel(b.title, c, d)
    })) : (new Hammer(a[0]).on("tap", function() {
        e.cancel(), new DemoPanel(b.title, c, d)
    }), new Hammer(l[0]).on("tap", function() {
        e.cancel(), new DemoPanel(b.title, c, d)
    })), this.$detail = f, e.getPanel().append(f.append(g.append(h).append(a)).append(i).append(j).append(k).append(l)).append(m), e.launch()
}
...
var hf_utils = {
    ...
    isMobile: function() {
        var a = navigator.userAgent || navigator.vendor || window.opera,
            b = "desktop";
        return /iPad/i.test(a) ? b = "tablet" : /iPhone|iPod/i.test(a) ? b = "mobile" : /Android/i.test(a) ? b = /Mobile/i.test(a) ? "mobile" : "tablet" : /Windows Phone/i.test(a) || /IEMobile/i.test(a) ? b = "mobile" : /BlackBerry|BB10/i.test(a) ? b = "mobile" : /SM-T\d+/i.test(a) ? b = "tablet" : /Tablet|PlayBook|Kindle|Silk/i.test(a) && (b = "tablet"), "desktop" != b
    },
    isLteIE8: function() {
    ...
    getBookUrl: function(a, b, c, d, e, f, g, h, i, j, k, l, m) {
        a = a.replace(/^http:/, location.protocol);
        var n = l.hasOwnProperty("coverimg") ? l.coverimg : a + "files/shot.jpg";
        j.attr("src", n), m && m(h, i, j, k, a, l)
    },
    ...
    getLangVal: function(a, b) {
        var c = {
            language: "Chinese",
            lbCnacelBtn: "بستن کاتالوگ",
            spTitle: "Share",
            spLabel: "Share link",
            spInput: "Share via",
            dpTitle: "Open in new window",
            dpToolTip: "Click here to close.",
            bdpTitle: "Book Detail",
            bdpPage: "Pages",
            bdpNewTime: "Published on",
            bdpView: "View",
            udpTitle: "Contact us",
            bdTitle: "选择下载版本",
            bdPDFBtn: "下载PDF",
            ...
            bcAllBooks: "همه دسته بندی ها",
            bcSearchText: "جستجو کاتالوگ",
            bcNewUpload: "جدید",
            bcOldUpload: "قدیمی",
            bcSearchResult: "بدون نتیجه. ",
            bcSearchBack: "برگشت",
            bcDownText: "下载",
            bcBookUnit: "book",
            bcBookUnits: "books",
...
Bookcase.prototype = {
    bindEvents: function() {
        ...
        if (hf_utils.isLteIE8() ? this.$content.on("click", ".book-wrapper", function() {
                var d = $(this).attr("data-index"),
                    e = a.bookObj[d],
                    f = "" == b.domain || window.location.href.indexOf(b.baseUrl.replace(/^https?:\/\//, "")) >= 0 ? e.url + "index.html" : "//" + b.domain + "/books/" + e.bLink + "/";
                switch ("" == b.domain || window.location.href.indexOf(b.baseUrl.replace(/^https?:\/\//, "")) >= 0 ? (f = e.url + "index.html", f = f.replace(/^http:/, location.protocol)) : f = "http://" + b.domain + "/books/" + e.bLink + "/", c) {
                    case "1":
                        new DemoPanel(e.title, f, b);
                        break;
                    case "2":
                        window.open(f, "_blank");
                        break;
                    default:
                        new BookDetailPanel($(this).clone(), e, f, b)
                }
                ...
                if (!e.hasClass("book-down") && (e.hasClass("book-wrapper") || f.length > 0)) {
                    ...
                    var g = e.attr("data-index"),
                        h = a.bookObj[g],
                        i = "" == b.domain || window.location.href.indexOf(b.baseUrl.replace(/^https?:\/\//, "")) >= 0 ? h.url + "index.html" : "//" + b.domain + "/books/" + h.bLink + "/";
                    switch ("" == b.domain || window.location.href.indexOf(b.baseUrl.replace(/^https?:\/\//, "")) >= 0 ? (i = h.url + "index.html", i = i.replace(/^http:/, location.protocol)) : i = "http://" + b.domain + "/books/" + h.bLink + "/", c) {
                        case "1":
                            new DemoPanel(h.title, i, b);
                            break;
                        case "2":
                            window.open(i, "_blank");
                            break;
                        default:
                            new BookDetailPanel(e.clone(), h, i, b)
                    }
                    try {
                        d.srcEvent.stopPropagation()
                    } catch (d) {}
                }
            }), hf_utils.isMobile()) this.$content.addClass("phone"), this.$content.on("scroll", function(b) {
            var c = a.$content.scrollTop();
            c = c < 0 ? 0 : c, a.setNumInput(c), b.stopPropagation()
        });
        else {
    ...
    createFooter: function() {
        var a = this.options,
            b = a.skin,
            c = a.logoName,
            d = "" == c ? "" : c.match(/^(https?:)?\/\//) ? c : "//" + a.AS3BucketName + "/" + a.uLink + "/" + c,
            e = a.logoLink,
            ...
            for (var g = "1" == this.options.isShowCategory && 0 == f ? "high-row" : "", h = $("<div class='case-row " + g + "'></div>"), i = $("<div class='case-wrapper'></div").width(c), j = 0; j < b; j++) {
                ...
                if (this.cache[m] && this.cache[m].length > 0) {
                    ...
                    var r = $("<div class='book-content' data-index='" + m + "' data-id='" + k + "' load-status='none'></div>"),
                        ...
                        t = ($("<div class='book-face'></div>"), $("<div class='book-down' title='下载' data-index='" + m + "' data-down='" + p + "'></div>"), $("<img class='book-img' src=''/>"));
        ...
        for (var b = this, c = b.options, d = this.cols * this.minRows + 2, e = 0; e <= d; e++) {
            ...
            if (g.length > 0 && "loaded" !== g.attr("load-status")) {
                var h = g.find(".book-wrapper"),
                    ...
                    j = g.attr("data-index"),
                    k = this.bookObj[j];
                hf_utils.getBookUrl(k.url, c.uLink, k.bLink, k.bStatus, k.isPublic, c.uType, k.auditStatus, g, h, i, j, k, b.autoFitToBottom2.bind(b))
            }
        }
    },
    ...
    autoFitToBottom2: function(a, b, c, d, e, f) {
        var g = this,
            h = new Image;
        h.onload = function() {
            ...
            var e, f, i = a.height(),
                ...
                l = i,
                m = i * k;
            m > j && (m = j, l = j / k), e = (j - m) / 2, f = i - l, b.css({
                width: m,
                height: l,
                left: e,
                top: f
            ...
            c.after(p), setTimeout(function() {
                b.fadeIn(400, function() {
                    g.cache[d] = a, a.attr("load-status", "loaded")
                }), a.find(".loading").remove()
            }, 50)
        }, h.onerror = function() {
            ...
            var f = new Image;
            f.onload = function() {
                f.onload = f.onerror = null, c.fadeIn();
                var e, h, i = a.height(),
                    j = a.width(),
                    k = f.width / f.height,
                    l = i,
                ...
                var e, h, i = $("<div class='as-book-img'></div>"),
                    j = a.height(),
                    k = a.width(),
                    l = .75,
                    m = j,
                    n = j * l;
                n > k && (n = k, m = k / l), e = (k - n) / 2, h = j - m, b.css({
                    width: n,
                    height: m,
                    left: e,
                    top: h
            ...
            }, f.src = e + "files/shot.png"
        }, h.src = f.hasOwnProperty("coverimg") ? f.coverimg : e + "files/shot.jpg"
    },
    ...
    createFolder: function(a, b) {
        ...
        for (var f = $("<div class='case-folder-content'></div").width(a), g = 0; g < e.length; g++) {
            ...
            $folderBooks = $("<div class='case-folder-num'>（" + p + "）</div>"), k.append(l.append(m.append(n).append($folderBooks))).appendTo(f)
        }
    ...
    createListFolder: function() {
        ...
        hf_utils.isLteIE8() ? (j.on("click", ".folder-list-item", function() {
            ...
            try {
                a.srcEvent.stopPropagation(), a.preventDefault()
            } catch (a) {}
            return !1
